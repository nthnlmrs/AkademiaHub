...
<x-app-layout>
    <div class="max-w-2xl">
        <div class="mb-6">
            ...
            <h2 class="text-2xl font-bold mt-2">Create Schedule</h2>
        </div>
        ...
        <div class="glass-card p-6">
            <form method="POST" action="{{ route('admin.schedules.store') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="room" value="{{ old('room') }}" class="form-input" placeholder="Leave blank to use class room">
                </div>
