...
<x-app-layout>
    <div class="max-w-2xl">
        <div class="mb-6">
            ...
            <h2 class="text-2xl font-bold mt-2">Create Class</h2>
        </div>
            ...
            <form method="POST" action="{{ route('admin.classrooms.store') }}" class="space-y-5">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="room" value="{{ old('room') }}" class="form-input" placeholder="Room 101">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="type" class="form-select" required>
                            <option value="LEC" {{ old('type') === 'LEC' ? 'selected' : '' }}>Lecture (LEC)</option>
                            <option value="LAB" {{ old('type') === 'LAB' ? 'selected' : '' }}>Laboratory (LAB)</option>
                        </select>
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <div class="select-list">
                        ...
                        @if($lecturers->isEmpty())
                            <p class="text-sm text-slate-500 p-2">No lecturers available. Create one first.</p>
                        @endif
                    </div>
                </div>
